...
\section{Prediktivni modeli}
	...
	Možemo primijetiti da \textit{Energy} i \textit{Loudness} imaju poprilično visoku pozitivnu korelaciju, što je i očekivano. \textit{Danceability} i \textit{Valence} također imaju pozitivnu korelaciju, međutim s manjom vrijednosti, što nam govori da je moguće da "plesne" pjesme imaju veću valenciju, tj. pozitivnost.
	S druge strane, \textit{Acousticness} i \textit{Energy} te \textit{Acousticness} i \textit{Loudness} imaju negativnu korelaciju, što znači da akustične trake većinom imaju manju energiju te manju glasnoću.
	...
	Podatkovni okvir razdijeljen je u 2 dijela, jedan za treniranje te jedan za testiranje modela metodom nasumičnog odabira. Veličina okvira za treniranje je 70\% originalnog podatkovnog skupa. 
